...
export const BagIcon = ({
  ...
  <svg width={size} height={size} viewBox="0 0 30 38" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M9.16667 14V8.16668C9.16667 7.40063 9.31755 6.64209 9.6107 5.93436C9.90386 5.22662 10.3335 4.58356 10.8752 4.04189C11.4169 3.50021 12.0599 3.07053 12.7677 2.77738C13.4754 2.48423 14.234 2.33334 15 2.33334C15.766 2.33334 16.5246 2.48423 17.2323 2.77738C17.9401 3.07053 18.5831 3.50021 19.1248 4.04189C19.6665 4.58356 20.0961 5.22662 20.3893 5.93436C20.6825 6.64209 20.8333 7.40063 20.8333 8.16668V14" stroke="#1C1825" strokeWidth="3.16667" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)
